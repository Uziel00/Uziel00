        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container">
                <a href="index.php" title="PHierros" class="navbar-brand">
                    <img src="media/logo_proyecto_BD_nombre_opt1.png" class="store-image logo" alt="Bootstrap">
                </a>
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <?php if ($_SESSION['usuario'] != "") { ?>
                                    <a class="nav-link active" aria-current="page" href=""><i class="fi-rr-user"></i><?php echo $user->getUsuario(); ?></a>
                                <?php } else { ?>
                ...
                <form action="buscar.php" class="d-flex container-fluid">
                    <input name="buscar" class="form-control mb-3" type="search" placeholder="Buscar" aria-label="Search">
                ...
                <div class="col">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <h5 class="card-title" style="white-space: nowrap; text-overflow: ellipsis; overflow: hidden;"><?php echo $productos->getNombre(); ?></h5>
                            <p class="card-text" style="; white-space: nowrap; text-overflow: ellipsis; overflow: hidden;"><?php echo $productos->getDescripcion(); ?></p>
                            <p class="card-text">Costo aproximado <br> $<?php echo $productos->getPrecio(); ?>.00</p>
