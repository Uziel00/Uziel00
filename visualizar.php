...
<body>
    ...
    <div class="container producto">
        <h3><?php echo $productos->getNombre(); ?></h3>
        <div class="row">
            ...
            <div class="col-lg-6">
                <form action="logica/administrar.php" method="POST" class="form-horizontal">
                    <div class="row mb-3">
                        <label for="precio" class="col-sm-3 col-md-3 col-form-label"><strong>Precio: </strong></label>
                    ...
                    <div class="row mb-3">
                        <label for="precio" class="col-sm-3 col-md-3 col-form-label"><strong>Cantidad: </strong></label>
                        <div class="col-sm-8 col-dm-9">
                    ...
                    <div class="row mb-3">
                        <label for="descripcion" class="col-sm-3 col-md-3 col-form-label"><strong>Descripcion: </strong></label>
                        <div class="col-sm-8 col-dm-9">
                            <label for="des" class="col-sm-10 col-form-label"><?php echo $productos->getDescripcion(); ?></label>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="Etiqueta" class="col-sm-3 col-md-3 col-form-label"><strong>Etiqueta:</strong> </label>
                        <div class="col-sm-8 col-dm-9">
                            <label for="mat" class="col-sm-10 col-form-label"><?php echo $productos->getEtiquetas(); ?></label>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="Materiales" class="col-sm-3 col-md-3 col-form-label"><strong>Materiales: </strong></label>
                        <div class="col-sm-8 col-dm-9">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-8 col-dm-9">
                            ...
                            <a href="index.php" class="btn btn-primary btn-block" title="← Continue Shopping">← Continuar comprando</a>
                        </div>
                    </div>
                </form>
            </div>
